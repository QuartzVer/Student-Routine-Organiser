...
function moodIcon($mood)
{
    return match ($mood) {
        ...
        'Anxious' => 'mdi-emoticon-confused',
        'Angry' => 'mdi-emoticon-angry',
        default => 'mdi-emoticon-neutral',
    };
}
function fmtMoney($v)
{
...
<script>
    ...
    (function() {
        ...
        var g = h >= 5 && h < 12 ? 'Good Morning' : h >= 12 && h < 18 ? 'Good Afternoon' : h >= 18 && h < 21 ? 'Good Evening' : 'Good Night';
        ...
        document.getElementById('dashDate').textContent = new Date().toLocaleDateString('en-US', {
            ...
            month: 'long',
            day: 'numeric'
        }) + ' — Here\'s your routine at a glance.';
    })();
    ...
    window.addEventListener('load', function() {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: function(ctx) {
                        ...
                        g.addColorStop(0, 'rgba(246,185,59,0.3)');
                        g.addColorStop(1, 'rgba(246,185,59,0.85)');
                        return g;
                    },
                    borderRadius: 6,
                    borderSkipped: false,
        ...
        new Chart(document.getElementById('dashHabChart').getContext('2d'), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    {
                        label: 'Done',
                        data: <?php echo json_encode(array_column($weekHabits, 'done')); ?>,
            ...
            new Chart(document.getElementById('dashExpChart').getContext('2d'), {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: <?php echo json_encode(array_slice($doughnutColors, 0, count($categories))); ?>,
                        borderWidth: 0,
                        hoverOffset: 6
                    }]
                },
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: Object.assign({}, tt, {
                            callbacks: {
                                label: function(c) {
                                    var t = c.dataset.data.reduce(function(a, b) {
                                        return a + b;
                                    }, 0);
                                    var p = t > 0 ? ((c.parsed / t) * 100).toFixed(0) : 0;
                                    return c.label + ': $' + c.parsed.toFixed(2) + ' (' + p + '%)';
                                }
                            }
                        })
                    }
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: <?php echo json_encode(array_map(function ($m) {
                                                return moodColor($m['mood_status']);
                                            }, $moodDist)); ?>,
                        borderWidth: 0,
                        hoverOffset: 6
                    }]
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: Object.assign({}, tt, {
                            callbacks: {
                                label: function(c) {
                                    return c.label + ': ' + c.parsed + ' entries';
                                }
                            }
                        })
                    }
        ...
        document.querySelectorAll('.kpi-ring circle:nth-child(2)').forEach(function(c) {
            ...
            requestAnimationFrame(function() {
                requestAnimationFrame(function() {
                    c.setAttribute('stroke-dasharray', orig);
                });
            });
        });
    });
